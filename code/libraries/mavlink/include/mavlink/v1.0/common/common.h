...
// FIXME Following line moved here to avoid build errors, since protocol.h includes
// string.h that contains overloaded functions and so cannot be compiled as extern "C"
